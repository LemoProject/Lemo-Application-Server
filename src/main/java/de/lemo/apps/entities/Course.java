/**
 * File ./de/lemo/apps/entities/Course.java
 * Date 2013-01-29
	...
	public Course(final CourseObject courseObject) {
		if (courseObject != null) {
			...
			if (courseObject.getFirstRequest() != null) {
				this.firstRequestDate = new java.util.Date(courseObject.getFirstRequest() * 1000);
			}
			if (courseObject.getLastRequest() != null) {
				this.lastRequestDate = new java.util.Date(courseObject.getLastRequest() * 1000);
			}
