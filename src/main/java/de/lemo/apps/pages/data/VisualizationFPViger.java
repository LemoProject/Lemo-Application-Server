...
//    }
    ...
    public String getQuestionResult() {
        ...
        if(minSup==null || minSup.equals(0)) minSup = 1;
        ...
        return analysis.computeQFrequentPathViger(courseIds, selectedUsers, types, pathLengthMin , pathLengthMax,  minSupDouble , considerLogouts, beginStamp, endStamp);
    }
