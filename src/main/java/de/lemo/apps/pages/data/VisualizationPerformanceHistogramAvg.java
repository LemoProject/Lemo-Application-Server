/**
 * File ./de/lemo/apps/pages/data/VisualizationPerformanceHistogramAvg.java
 * Date 2013-01-29
...
public class VisualizationPerformanceHistogramAvg {
	...
	public String getQuestionResult() {
		...
		if (this.courseId != null) {
			...
			final List<Long> results = this.analysis.computePerformanceHistogram(courseList, this.selectedUsers,
					quizzesList, this.resolution, beginStamp, endStamp);
