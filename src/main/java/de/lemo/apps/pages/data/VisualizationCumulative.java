/**
 * File ./de/lemo/apps/pages/data/VisualizationCumulative.java
 * Date 2013-01-29
...
public class VisualizationCumulative {
	...
	public String getQuestionResult() {
		if (this.courseId != null) {
			...
			final String result = this.analysis.computeCumulativeUserAccess(courses, types, null, null, beginStamp,
					endStamp);
