...
@Import(library = { "../../js/d3/nvd3_custom_Usage_Chart.js" })
...
//    }
    ...
    public String getQuestionResult() {
        ...
        ResultListLongObject results = analysis.computeQ1(courseIds, null, beginStamp, endStamp, resolution, types);
        ...
        for (int i = 0;i<results.getElements().size();i++){
        	...
        	Integer dateMultiplier = 60*60*24*i*100;
        ...
        for (int i = 0;i<results2.getElements().size();i++){
        	JSONArray graphValue2 = new JSONArray();
        	Integer dateMultiplier2 = 60*60*24*i;
